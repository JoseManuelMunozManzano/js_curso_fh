...
export const asyncAwaitComponent = async (element) => {
  ...
  // Las excepciones de async-await se tratan en un try-catch
  try {
...
const findHero = async (id) => {
  ...
  // Si queremos que la promesa se rechace se hace con un throw, no con return.
  // La función llamadora estará en un try-catch
  if (!hero) throw `hero not found`;

  // Recordar que un return SIEMPRE es existoso!!
  return hero;
};
