const miModulo = (() => {
  ...
  let e = [],
    ...
    i = (t = 2) => {
      ...
      s.forEach((e) => (e.innerText = 0)), o.forEach((e) => (e.innerHTML = '')), (l.disabled = !1), (n.disabled = !1);
    },
    c = () => {
      e = [];
    ...
    h = (e, t) => ((a[t] += $(e)), (s[t].innerText = a[t]), a[t]),
    f = (e, t) => {
      let r = document.createElement('img');
      r.classList.add('carta'), (r.src = `assets/cartas/${e}.png`), (r.alt = `Carta ${e}`), o[t].append(r);
    },
    b = () => {
      let [e, t] = a;
      setTimeout(() => {
  ...
  return (
    l.addEventListener('click', () => {
      ...
      f(e, 0),
        t > 21
          ? (console.warn('Lo siento mucho, perdiste'), (l.disabled = !0), (n.disabled = !0), g(t))
          : 21 === t && (console.warn('21, genial!'), (l.disabled = !0), (n.disabled = !0), g(t));
    }),
